...
const Footer = () => {
  return (
    <footer className="footer p-10 bg-secondary text-base-content rounded-t-3xl mt-12 px-4 md:px-12 text-white/80">
      <nav>
      ...
      <form>
        ...
        <fieldset className="form-control w-80">
          <label className="label">
            <span className="label-text text-white/50">Enter your email address</span>
          </label>
          <div className="join">
            <input
              type="text"
